...
pub async fn api(
  ...
  let body = match request.body {
    ...
    requests::RequestKind::MethodParametersGet(requests::MethodParametersGet {
      session_id: _,
      method_id: _,
    }) => ResponseKind::MethodParameters(responses::MethodParameters {
      parameters: vec![responses::MethodParameter {
        short_name: "P_NAME".to_string(),
        class_id: "NAME".to_string(),
        position: 1,
        reference_type: "D".to_string(),
    ...
    requests::RequestKind::MethodControlsGet(requests::MethodControlsGet {
      session_id: _,
      form_id: _,
    }) => ResponseKind::Controls(responses::Controls {
      controls: vec![
        responses::Control {
          id: 14_682_335,
          method_id: 311,
          qualifier: String::new(),
          control: responses::ControlType::Form,
          caption: "Добавить".to_string(),
          parent_id: None,
          top: 0,
          left: 0,
          height: 2415,
        ...
        responses::Control {
          id: 14_682_336,
          method_id: 311,
          qualifier: "%PARAM%.P_NAME".to_string(),
          control: responses::ControlType::Label,
          caption: "Фамилия Имя Отчество".to_string(),
          parent_id: Some(14_682_335),
          top: 120,
          left: 120,
          height: 360,
          width: 2580,
          tab_index: 2,
          position: 1,
          validate_name: "Label1".to_string(),
          properties: None,
          tips: Some("Поясняющая надпись (Фамилия Имя Отчество)".to_string()),
          class_id: None,
          depend: None,
        },
        responses::Control {
          ...
          method_id: 311,
          qualifier: "%PARAM%.P_NAME".to_string(),
          control: responses::ControlType::Text,
          caption: String::new(),
          parent_id: Some(14_682_335),
          top: 120,
          left: 2760,
          ...
          tab_index: 3,
          position: 2,
          validate_name: "Text1".to_string(),
          properties: Some("|V|".to_string()),
          tips: Some("Фамилия Имя Отчество".to_string()),
          class_id: Some("NAME".to_string()),
          depend: None,
        },
        responses::Control {
          id: 14_682_338,
          method_id: 311,
          qualifier: "%PARAM%.P_USERNAME".to_string(),
          control: responses::ControlType::Label,
          caption: "Сетевое имя".to_string(),
          parent_id: Some(14_682_335),
          top: 540,
          left: 120,
          height: 360,
          ...
          tab_index: 4,
          position: 3,
          validate_name: "Label2".to_string(),
          properties: None,
          tips: Some("Поясняющая надпись (Сетевое имя)".to_string()),
          class_id: None,
          depend: None,
        },
        responses::Control {
          ...
          tab_index: 5,
          position: 4,
          validate_name: "Text2".to_string(),
          properties: Some("|V|".to_string()),
          tips: Some("Сетевое имя".to_string()),
          class_id: Some("STRING_30".to_string()),
          depend: None,
        },
        responses::Control {
          id: 14_682_344,
          method_id: 311,
          qualifier: "OK".to_string(),
          control: responses::ControlType::Button,
          ...
          tab_index: 10,
          position: 5,
          validate_name: "OK".to_string(),
          properties: None,
          tips: Some("Выполнить метод".to_string()),
          class_id: None,
          depend: None,
        },
        responses::Control {
          id: 14_682_345,
          method_id: 311,
          qualifier: "CANCEL".to_string(),
          control: responses::ControlType::Button,
          caption: "Отмена".to_string(),
          parent_id: Some(14_682_335),
          top: 1740,
          left: 6060,
          height: 360,
          ...
          tab_index: 11,
          position: 6,
          validate_name: "CANCEL".to_string(),
          properties: None,
          tips: Some("Отказ от выполнения".to_string()),
          class_id: None,
          depend: None,
        },
      ],
