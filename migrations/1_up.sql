...
VALUES  (311,       0,          "Тестовая операция",    "NEW#AUTO",     "M",    "USER",         "TEST",                 NULL,       NULL,               1,              NULL,           NULL,           NULL,               "|ARCHPACK 0|BUF |CMD Y|COMMIT N|COMPILER 01111011111111FF0000|CREATE N|CRITICAL N|DEFHOTKEY Y|EMPTY_ID N|FOCUS_VALIDATE 2|HOTKEY 368|IPIPE |LOAD_VALIDATE 2|OPIPE |PARAMS N|PRIORITY 100|REFRESH Y|RTLBASE 807001|RUN_MON N|SHARE N|STREAM N|"),
        (6503609,   6,          "Добавить",             "NEW#AUTO",     "C",    "FP_TUNE",      "NEW#AUTO",             NULL,       "FP_TUNE",          1,              6503613,        NULL,           NULL,               "|ARCHPACK 0|BUF |CMD N|COMMIT N|COMPILER 01011011110111FF0010|CREATE Y|CRITICAL N|DEFHOTKEY N|EMPTY_ID N|FOCUS_VALIDATE 2|HOTKEY 00|IPIPE |LOAD_VALIDATE 2|OPIPE |PARAMS N|PRIORITY 100|REFRESH N|RTLBASE 212801|RUN_MON N|SHARE N|STREAM N|"),
        (6503613,   6,          "Изменить",             "EDIT#AUTO",    "M",    "FP_TUNE",      "EDIT#AUTO",            "SOURCES",  NULL,               1,              NULL,           NULL,           NULL,               "|ARCHPACK 0|BUF |CMD N|COMMIT N|COMPILER 11111011100111FF0010|CREATE N|CRITICAL N|DEFHOTKEY Y|EMPTY_ID N|FOCUS_VALIDATE 2|HOTKEY 0114|IPIPE |LOAD_VALIDATE 2|OPIPE |PARAMS N|PRIORITY 100|REFRESH Y|RTLBASE 213401|RUN_MON N|SHARE N|STREAM N|")
;
...
VALUES  -- ::[USER].[NEW#AUTO] "Тестовая операция"
        ...
        (17007816,  6503613,    NULL,                           "FORM",     0,    0,    7703,   12214,  0,          0,        "Form1",              NULL,       NULL,               NULL,       NULL,               "Изменить",                                                             NULL),
        (17007817,  6503613,    "%PARAM%.P_CODE",               "LABEL",    900,  60,   360,    1680,   0,          1,        "Label1",             17007816,   NULL,               NULL,       NULL,               "Код",                                                                  "Поясняющая надпись (Код)"),
        (17007818,  6503613,    "%PARAM%.P_CODE",               "TEXT",     900,  1740, 360,    3720,   2,          2,        "Text1",              17007816,   "STRING_30",        NULL,       "|V|",              "",                                                                     "Код"),
        (17007819,  6503613,    "%PARAM%.P_NAME",               "LABEL",    480,  60,   360,    1680,   0,          3,        "Label2",             17007816,   NULL,               NULL,       NULL,               "Наименование",                                                         "Поясняющая надпись (Наименование)"),
        (17007820,  6503613,    "%PARAM%.P_NAME",               "TEXT",     480,  1740, 360,    10380,  1,          4,        "Text2",              17007816,   "STRING_100",       NULL,       NULL,               "",                                                                     "Наименование"),
        (17007821,  6503613,    "OK",                           "BUTTON",   7125, 7680, 360,    2160,   25,         5,        "OK",                 17007816,   NULL,               NULL,       "|V|",              "OK",                                                                   "Выполнить метод"),
        (17007822,  6503613,    "CANCEL",                       "BUTTON",   7125, 9960, 360,    2160,   26,         6,        "CANCEL",             17007816,   NULL,               NULL,       "|V|",              "Отмена",                                                               "Отказ от выполнения"),
        (17007823,  6503613,    NULL,                           "SUBFORM",  345,  0,    7671,   12336,  0,          7,        "Form2",              17007816,   NULL,               NULL,       NULL,               "Описание",                                                             NULL),
        (17007824,  6503613,    "%PARAM%. ",                    "LINE",     555,  1080, 570,    1080,   0,          8,        "Line1",              17007823,   NULL,               NULL,       NULL,               "",                                                                     "Линия"),
        (17007825,  6503613,    "%PARAM%.P_NOTE",               "MEMO",     60,   60,   7500,   12120,  32,         9,        "Memo3",              17007823,   "MEMO",             NULL,       NULL,               "",                                                                     NULL),
        (17007826,  6503613,    "%VAR%.V_VAL_TYPE_ENABLED",     "CHECK",    7380, 2280, 240,    240,    31,         10,       "VAL_TYPE_ENABLED",   17007816,   "BOOLEAN",          NULL,       "#@#|Vb 0|",        "",                                                                     "Логика(Разрешить изменение типа зн.)"),
        (17007827,  6503613,    "%PARAM%. ",                    "FRAME",    6180, 5460, 660,    2448,   0,          11,       "frame_find_by",      17007816,   NULL,               NULL,       NULL,               "",                                                                     NULL),
        (17007828,  6503613,    "%PARAM%. ",                    "FRAME",    3480, 60,   2760,   12060,  0,          12,       "values_frame",       17007816,   NULL,               NULL,       NULL,               "",                                                                     NULL),
        (17007829,  6503613,    "%VAR%.V_VAL_ENABLED",          "CHECK",    7380, 1800, 240,    240,    30,         13,       "VALUE_ENABLED",      17007816,   "BOOLEAN",          NULL,       "#@#|Vb 0|",        "",                                                                     "Логика(Найдено общее значение)"),
        (17007830,  6503613,    "%VAR%.V_VAL",                  "LABEL",    180,  60,   360,    1260,   0,          14,       "Label3",             17007828,   NULL,               NULL,       NULL,               "Значение",                                                             "Поясняющая надпись-(Значение: строка)"),
        (17007831,  6503613,    "%VAR%.V_VAL",                  "TEXT",     180,  1320, 360,    10560,  14,         15,       "value",              17007828,   "STRING_2000",      NULL,       "|V|",              "",                                                                     "Значение: строка"),
        (17007832,  6503613,    "%VAR%.V_VAL_DATE",             "DATE",     180,  1320, 360,    1130,   15,         16,       "val_date",           17007828,   "DATE",             NULL,       "|V|",              "",                                                                     "Значение: дата"),
        (17007833,  6503613,    "%VAR%.V_VAL_REF",              "OBJECT",   180,  60,   780,    2880,   13,         17,       "val_ref",            17007828,   "REFERENCE",        NULL,       "|V|#@#|Vb 0|",     "Ссылка",                                                               "Объект:Значение: ссылка"),
        (17007834,  6503613,    "%VAR%.V_VAL_REF_TXT",          "TEXT",     420,  2940, 360,    8940,   19,         18,       "VAL_REF_TXT",        17007828,   "STRING_2000",      NULL,       "#@#|Lc 1|",        "",                                                                     "Информационное поле для ссылки"),
        (17007835,  6503613,    "%VAR%.V_VAL_BOOL.0",           "VARIANT",  240,  3120, 240,    2100,   18,         19,       "val_bool_null",      17007828,   "NUMBER",           NULL,       "3|V|",             "Не определено",                                                        "Вариант(Значение 3)"),
        (17007836,  6503613,    "%VAR%.V_VAL_BOOL.0",           "VARIANT",  240,  2220, 240,    840,    17,         20,       "val_bool_no",        17007828,   NULL,               NULL,       "2|V|",             "Нет",                                                                  "Вариант(Значение 2)"),
        (17007837,  6503613,    "%VAR%.V_VAL_BOOL.0",           "VARIANT",  240,  1380, 240,    780,    16,         21,       "val_bool_yes",       17007828,   NULL,               NULL,       "1|V|",             "Да",                                                                   "Вариант(Значение 1)"),
        (17007838,  6503613,    "%PARAM%.P_GROUP_ID",           "LABEL",    60,   60,   360,    1680,   0,          22,       "Label4",             17007816,   NULL,               NULL,       NULL,               "Группа",                                                               "Поясняющая надпись-(Идентификатор группы)"),
        (17007839,  6503613,    "%PARAM%.P_GROUP_ID",           "TEXT",     60,   1740, 360,    5400,   0,          23,       "Text7",              17007816,   "STRING_30",        NULL,       NULL,               "",                                                                     "Идентификатор группы"),
        (17007840,  6503613,    "%VAR%.V_RESET_ARR",            "CHECK",    7380, 1440, 240,    240,    29,         24,       "V_RESET_ARR",        17007816,   "BOOLEAN",          NULL,       "|D|#@#|Vb 0|",     "",                                                                     "Логика(Корректировать массив значений при выходе)"),
        (17007841,  6503613,    "%PARAM%.P_CANONS",             "ARRAY",    195,  165,  375,    1875,   22,         25,       "Array1",             17007827,   "FP_TUNE_CN_ARR",   NULL,       NULL,               "Критерии",                                                             "Массив(Критерии)"),
        (17007842,  6503613,    "%PARAM%.P_USE_CANONS",         "CHECK",    6420, 60,   240,    5328,   23,         26,       "find_by",            17007816,   "BOOLEAN",          NULL,       "|V|",              "Использовать критерии выбора значения",                                "Логика(Использовать критерии поиска)"),
        (17007843,  6503613,    "%VAR%.V_VAL_TYPE",             "FRAME",    1320, 60,   2220,   12060,  0,          27,       "val_type_frame",     17007816,   "EIGHT_CHOICE",     NULL,       "|V|",              "Тип значения",                                                         "Вариант(Вариант: тип значения)"),
        (17007844,  6503613,    "%VAR%.V_VAL_TYPE.0",           "VARIANT",  240,  120,  240,    1320,   5,          28,       "Variant3",           17007843,   "EIGHT_CHOICE",     NULL,       "1|V|",             "Строка",                                                               "Вариант(Значение 1)"),
        (17007845,  6503613,    "%PARAM%. ",                    "PANEL",    240,  1740, 1620,   10140,  0,          29,       "Panel8",             17007843,   NULL,               17007844,   NULL,               "",                                                                     "Контейнер элементов варианта(Значение 1)"),
        (17007846,  6503613,    "%VAR%.V_VAL_TYPE.0",           "VARIANT",  480,  120,  240,    1260,   6,          30,       "Variant4",           17007843,   NULL,               NULL,       "2|V|",             "Число",                                                                "Вариант(Значение 2)"),
        (17007847,  6503613,    "%PARAM%. ",                    "PANEL",    240,  1740, 1620,   10140,  0,          31,       "Panel9",             17007843,   NULL,               17007846,   NULL,               "",                                                                     "Контейнер элементов варианта(Значение 2)"),
        (17007848,  6503613,    "%VAR%.V_VAL_TYPE.0",           "VARIANT",  720,  120,  240,    1260,   7,          32,       "Variant5",           17007843,   NULL,               NULL,       "3|V|",             "Дата",                                                                 "Вариант(Значение 3)"),
        (17007849,  6503613,    "%PARAM%. ",                    "PANEL",    240,  1740, 1620,   10140,  0,          33,       "Panel10",            17007843,   NULL,               17007848,   NULL,               "",                                                                     "Контейнер элементов варианта(Значение 3)"),
        (17007850,  6503613,    "%VAR%.V_VAL_TYPE.0",           "VARIANT",  960,  120,  240,    1440,   8,          34,       "Variant6",           17007843,   NULL,               NULL,       "4|V|",             "Логика",                                                               "Вариант(Значение 4)"),
        (17007851,  6503613,    "%PARAM%. ",                    "PANEL",    240,  1740, 1620,   10140,  0,          35,       "Panel11",            17007843,   NULL,               17007850,   NULL,               "",                                                                     "Контейнер элементов варианта(Значение 4)"),
        (17007852,  6503613,    "%VAR%.V_VAL_TYPE.0",           "VARIANT",  1200, 120,  240,    1380,   9,          36,       "Variant7",           17007843,   NULL,               NULL,       "5|V|",             "Ссылка",                                                               "Вариант(Значение 5)"),
        (17007853,  6503613,    "%PARAM%. ",                    "PANEL",    240,  1740, 1620,   10140,  0,          37,       "Panel12",            17007843,   NULL,               17007852,   NULL,               "",                                                                     "Контейнер элементов варианта(Значение 5)"),
        (17007854,  6503613,    "%VAR%.V_VAL_TYPE.0",           "VARIANT",  1440, 120,  240,    1320,   10,         38,       "Variant15",          17007843,   NULL,               NULL,       "6|V|",             "Мемо",                                                                 "Вариант(Значение 6)"),
        (17007855,  6503613,    "%PARAM%. ",                    "PANEL",    240,  1740, 1620,   10140,  0,          39,       "Panel13",            17007843,   NULL,               17007854,   NULL,               "",                                                                     "Контейнер элементов варианта(Значение 6)"),
        (17007856,  6503613,    "%VAR%.V_VAL_TYPE.0",           "VARIANT",  1920, 120,  240,    1440,   12,         40,       "Variant16",          17007843,   NULL,               NULL,       "7|V|",             "Функция",                                                              "Вариант(Значение 7)"),
        (17007857,  6503613,    "%PARAM%. ",                    "PANEL",    240,  1740, 1620,   10140,  0,          41,       "Panel14",            17007843,   NULL,               17007856,   NULL,               "",                                                                     "Контейнер элементов варианта(Значение 7)"),
        (17007858,  6503613,    "%VAR%.V_VAL_TYPE.0",           "VARIANT",  1680, 120,  240,    1560,   11,         42,       "Variant9",           17007843,   NULL,               NULL,       "8|V|",             "CLOB",                                                                 "Вариант(Значение 8)"),
        (17007859,  6503613,    "%PARAM%. ",                    "PANEL",    240,  1740, 1620,   10140,  0,          43,       "Panel15",            17007843,   NULL,               17007858,   NULL,               "",                                                                     "Контейнер элементов варианта(Значение 8)"),
        (17007860,  6503613,    "%VAR%.V_MEMO",                 "MEMO",     600,  60,   1800,   11820,  20,         44,       "val_memo",           17007828,   "MEMO",             NULL,       "|V|",              "",                                                                     NULL),
        (17007861,  6503613,    "%VAR%.V_VAL_TYPE_REF",         "OBJECT",   60,   60,   360,    1860,   3,          45,       "Object1",            17007853,   "METACLASS_REF",    NULL,       "|V|",              "Тип значения",                                                         "Объект:Тип значения"),
        (17007862,  6503613,    "%VAR%.V_VAL_TYPE_REF.NAME",    "TEXT",     60,   1920, 360,    8100,   4,          46,       "val_type_name",      17007853,   "STRING",           17007861,   "|V|",              "",                                                                     "Class Name"),
        (17007863,  6503613,    "%PARAM%. ",                    "LABEL",    2400, 60,   300,    7860,   0,          47,       "memo_note",          17007828,   NULL,               NULL,       "#@#|Be 0|",        "При получении значения символ с кодом 13 удаляется из мемо-поля",      NULL),
        (17007864,  6503613,    "%PARAM%.P_VAL_TYPE",           "TEXT",     7260, 2580, 360,    1860,   27,         48,       "val_type",           17007816,   "STRING_16",        NULL,       "#@#|Vb 0|",        "",                                                                     "Тип значения"),
        (17007865,  6503613,    "%VAR%.V_VAL_REF_TYPE",         "TEXT",     7260, 4440, 360,    1980,   28,         49,       "val_ref_type",       17007816,   "STRING_100",       NULL,       "|V|#@#|Vb 0|",     "",                                                                     "Тип ссылки на значение"),
        (17007866,  6503613,    "%PARAM%.P_CACHED",             "CHECK",    6648, 60,   495,    5100,   24,         50,       "Check5",             17007816,   "BOOLEAN",          NULL,       "|V|",              "Кэшировать получение значений",                                        "Логика(Кэшировать получение значений)"),
        (17007867,  6503613,    "%PARAM%. ",                    "LABEL",    7005, 60,   315,    7080,   0,          51,       "Label6",             17007816,   NULL,               NULL,       "#@#|Be 0|FS 8|",   "Кэширование рекомендуется использовать для редко изменяемых настроек", "Надпись"),
        (17007868,  6503613,    "Кнопка1",                      "BUTTON",   600,  60,   360,    3600,   21,         52,       "val_clob_btn",       17007828,   NULL,               NULL,       "|V|",              "Просмотр / Изменение",                                                 "Кнопка1")
;
